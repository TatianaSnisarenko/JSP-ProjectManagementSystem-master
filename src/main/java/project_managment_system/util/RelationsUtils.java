...
import project_managment_system.service.converters.*;
...
public class RelationsUtils {
    ...
    static {
        ...
        DATA_SOURCE =DatabaseConnectionManager.getDataSource();
    }
    ...
    public static CompanyDao getCompanyForDeveloper(int idCompany) {
        CompanyRepository companyRepository = new CompanyRepository(DATA_SOURCE);
